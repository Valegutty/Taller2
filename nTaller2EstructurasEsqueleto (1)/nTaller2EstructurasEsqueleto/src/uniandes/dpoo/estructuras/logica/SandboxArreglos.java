...
{ 
     ...
     * @return La cantidad de enteros en el arreglo
     */
     ...
     * @return La cantidad de cadenas en el arreglo
     */
    ...
    public void agregarEntero( int entero )
    {
    	...
    	nuevoArreglo[getCantidadEnteros()] = entero;
    ...
    {
    	String[] nuevoArreglo = new String[getCantidadCadenas()+1];
    	
    	for(int i=0; i<getCantidadCadenas(); i++)
    	{
    		nuevoArreglo[i] = arregloCadenas[i];
    	}
    	nuevoArreglo[getCantidadCadenas()] = cadena;
    ...
    public void eliminarEntero( int valor )
    {
    	...
    	int[] nuevoArreglo = new int[getCantidadEnteros()-cantidadDel];
    	int j = 0;
    	for(int i1=0; i1<getCantidadEnteros(); i1++)
    	{
    ...
    public void eliminarCadena( String cadena )
    {
    	...
    	String[] nuevoArreglo = new String[getCantidadCadenas()-contadorDel];
    	int j = 0;
    	for(int i1=0; i1<getCantidadCadenas(); i1++)
    	{
    		if(!arregloCadenas[i1].equals(cadena))
    		{
    			nuevoArreglo[j++] = arregloCadenas[i1];
    		}
    	}
    	arregloCadenas = nuevoArreglo;
    }
    ...
    {
        int cantidadActual = getCantidadEnteros();
        int[] nuevoArreglo = new int[cantidadActual + 1];

        if (posicion < 0) 
        {
            posicion = 0;
        } 
        else if (posicion > cantidadActual) 
        {
            posicion = cantidadActual;
        }
     ...
     * @param objetos Un arreglo de objetos
     */
